...
namespace Fita_de_Preco.Models
{
    public class DBContexto
    {
        ...
        public void ObterPlanoDBOLD()
        {
            ConnectionStringSettings getString = WebConfigurationManager.ConnectionStrings["DBOLD"] as ConnectionStringSettings;
